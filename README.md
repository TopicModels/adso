...
[![Build Status](https://github.com/TnTo/adso/workflows/Build%20Master/badge.svg)](https://github.com/TnTo/adso/actions)
[![Documentation](https://github.com/TnTo/adso/workflows/Documentation/badge.svg)](https://TnTo.github.io/adso)
[![Code Coverage](https://codecov.io/gh/TnTo/adso/branch/master/graph/badge.svg)](https://codecov.io/gh/TnTo/adso)
...
## Installation
**Stable Release:** `pip install adso`<br>
**Development Head:** `pip install git+https://github.com/TnTo/adso.git`

## Documentation
For full package documentation please visit [TnTo.github.io/adso](https://TnTo.github.io/adso).
...
* Turn your project into a GitHub repository:
  ...
  * After a GitHub repo has been created, run the following commands:
    * `git remote add origin git@github.com:TnTo/adso.git`
    * `git push -u origin master`
* Register adso with Codecov:
  * Make an account on [codecov.io](https://codecov.io)
  (Recommended to sign in with GitHub)
  * Select `TnTo` and click: `Add new repository`
  * Copy the token provided, go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/TnTo/adso/settings/secrets),
...
generation to work
  ...
  * Go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/TnTo/adso/settings/secrets),
...
* Add branch protections to `master` and `stable`
    * To protect from just anyone pushing to `master` or `stable` (the branches with
    ...
    configurations)
    * Go to your [GitHub repository's settings and under the `Branches` tab](https://github.com/TnTo/adso/settings/branches), click `Add rule` and select the
